...
def train(model, dm, name, epochs=40, precision="32", debug=False):
    ...
    #logger = pl.loggers.TensorBoardLogger("./logs", name, version=version, log_graph=False)
...
if __name__ == "__main__":
    ...
    dm = DisAMRDataModule("/home/nrashvan/new_CSP/cspb_no_noise (1).hdf5", args.bs, n_rx=args.nrx)
